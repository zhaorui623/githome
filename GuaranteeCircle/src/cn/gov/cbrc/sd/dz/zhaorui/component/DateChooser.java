...
public class DateChooser extends JPanel
{
        ...
        private void init() throws Exception {
            dateField.setToolTipText("单击可选择日期");
            btnChoose.setToolTipText("单击可选择日期");
            this.setLayout(gridBagLayout1);
            dateField.setEditable(false);
            dateField.addMouseListener(new MouseListener() {				
				@Override
				...
				public void mouseClicked(MouseEvent e) {
					DateChooser.this.btnChoose_actionPerformed(null);
				}
			});
            ...
            this.add(dateField,"Center");
            this.add(btnChoose,"East");
...
//    
    ...
    //控制条配色------------------//
            ...
            private void createYearAndMonthPanal() {
                ...
                int currentMinu=c.get(Calendar.MINUTE);
                ...
                hourSpin = new JSpinner(new javax.swing.SpinnerNumberModel(
                        currentHour, 0, 23,
                        1));
                miSpin = new JSpinner(new javax.swing.SpinnerNumberModel(
                        currentMinu, 0, 59,
                        1));
                ...
                miSpin.setPreferredSize(new Dimension(35, 20));
                miSpin.setName("Minu");
                miSpin.addChangeListener(this);
                yearPanel.add(miSpin);

                JLabel miLabel = new JLabel("分");
                miLabel.setForeground(controlTextColor);
                yearPanel.add(miLabel);
            }
    ...
    //            c.set
            ...
            private int getSelectedMinu() {
                return ( (Integer) miSpin.getValue()).intValue();
            }
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (source.getName().equals("Minu")) {
                    calendar.set(Calendar.MINUTE, getSelectedMinu());
                    return;
                }
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
                    ...
                    int month = Integer.parseInt(monthSpin.getValue().toString());
                    int day = Integer.parseInt(value);
                    int hour= Integer.parseInt(hourSpin.getValue().toString());
                    int minu=Integer.parseInt(miSpin.getValue().toString());
